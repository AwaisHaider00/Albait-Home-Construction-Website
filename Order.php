...
$sql = "select orders.id, orders.uno, orders.orderDate,orders.paymentStatus, client.mobile, orders.totalAmount, orders.paid, orders.paymentType, orders.project_id, project.projectname, project.pmanager, client.name from orders inner JOIN project on project.id = orders.project_id inner JOIN client on  client.id = project.client_id";
