            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <th>Date</th>
                                       ...
                                       <tbody>
                                        <?php
                                        $sql="select  project.id, project.projectname, project.pmanager, project.date1, project.deadline, project.status, project.delete_status, project.client_id, client.name, client.mobile from project inner JOIN client on client.id = project.client_id";
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="addprogress.php?id=<?php echo $row1['id']?>" ><button type="button" class="btn btn-xs btn-success" ><i class="fa fa-plus-square"></i></button></a>
                                                 <a href="projectExpense.php?id=<?php echo $row1['id']?>" >
