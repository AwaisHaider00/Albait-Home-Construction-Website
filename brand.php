...
if(isset($_GET['op']))
{
     ...
     $deletResult = mysqli_query($connect, $deleteQuery);
     
     if($deletResult)
     {
          ?>
       <script> window.location.href= "brand.php"; </script>
      <?php
     }
}
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="?id=<?php echo $row['brand_id']?>&op=delete" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
