 ...
 if(isset($_GET['type'])=='status'&&$_GET['operation']!="")
{
   ...
   $update_querys = "update employee set status='$status' WHERE id = '$a_id'";
       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> View Employee</h3> </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add_employee.php"><button class="btn btn-primary">Add Employee</button></a>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                       ...
                                       { 
                                           ...
                                           ?>
                                            ...
                                            <td><span class="name"></span><?php echo $row['profession'] ?></td>
                                            <td><span class="name"></span><?php echo $row['wage'] ?></td>
                                            <td><span class="name"></span><?php echo $row['wage_type'] ?></td>
                           ...
                           <?php 
                                       ...
                                       ?>
                                            ...
                                            <td>
                                                <a href="editemployee.php?id=<?php echo $id; ?>"><span class="btn btn-success">edit</span></a>
