...
$get_id=$_GET['id'];
$query="select *from employee where id='$get_id'";
...
$rows=mysqli_fetch_assoc($r);
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query =  "update employee set name='$name',contact='$contact',profession='$profession',
        wage='$wage',wage_type='$wage_type',address='$address' where id='$get_id'";
        
        $result = mysqli_query($connect,$query);
        if($result)
        {
            echo "<script>window.open('view_employee.php','_self')</script>";
        }
        else
        {
                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="name" value="<?php echo($rows['name']); ?>" class="form-control"id="brandName" placeholder="Employee Name"   required="" pattern="^[a-z -z]+$"/>
                                                </div>
                                            </div>
                                             </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="contact" value="<?php echo($rows['contact']); ?>"   class="form-control"id="brandName" placeholder="Enter contact"  required="" pattern="^[a-z -z]+$"/>
                                                </div>
                                            </div>
                                             </div>
                                            <br>
                                      <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="profession" value="<?php echo($rows['profession']); ?>"  class="form-control"id="brandName" placeholder="Enter profession"   required="" pattern="^[a-z -z]+$"/>
                                                </div>
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="wage" value="<?php echo($rows['wage']); ?>"  class="form-control"id="brandName" placeholder="Enter wage"   required="" pattern="^[a-z -z]+$"/>
                                                </div>
                                            </div>
                                             </div>
                                        <br>
                                         <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="address" value="<?php echo($rows['address']); ?>"   class="form-control"id="brandName" placeholder="Enter Address"   required="" pattern="^[a-z -z]+$"/>
                                                </div>
                                            </div>
                                             </div>
