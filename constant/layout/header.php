...
<div class="header"> 
  <div class="">
      <nav class="navbar top-navbar navbar-expand-md navbar-light">
         ...
         <b><img src="./assets/myimages/logo1.png" style="width:180px;" alt="homepage" class="dark-logo" style="width:70%;height:auto;"/></b>
         </a>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample07">
          <ul class="navbar-nav nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-archive mr-2"></i> Project</a>
            ...
            <li class="nav-item dropdown">
             ...
             <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-money mr-2"></i> Expenses</a>
              <div class="dropdown-menu animated zoomIn" aria-labelledby="dropdown05">
                <a class="dropdown-item" href="add-expenses.php">Add Expenses</a>
                <a class="dropdown-item" href="view_expenses.php">Manage Expenses</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-truck mr-2"></i> Suppliers</a>
              <div class="dropdown-menu animated zoomIn" aria-labelledby="dropdown05">
                <a class="dropdown-item" href="add-supplier.php">Add Suppliers</a>
                <a class="dropdown-item" href="view_supplier.php">Manage Suppliers</a>
              </div>
            </li>
            
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user mr-2"></i> Clients</a>
              <div class="dropdown-menu animated zoomIn" aria-labelledby="dropdown05">
                <a class="dropdown-item" href="add-client.php">Add Client</a>
                <a class="dropdown-item" href="manageClient.php">Manage Client</a>
              </div>
            </li>
            
              <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-users mr-2"></i> Employees</a>
              <div class="dropdown-menu animated zoomIn" aria-labelledby="dropdown05">
                <a class="dropdown-item" href="add_employee.php">Add Employee</a>
                <a class="dropdown-item" href="view_employee.php">Manage Employee</a>
              </div>
            </li>
