                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Select Project</label>
                                               <div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
                                                <?php  
                                                  $project_id = $_GET['id'];
                                                  $q = "select *from project where project.id = '$project_id' ";
                                                  $r = mysqli_query($connect, $q);
                                                  $rr = mysqli_fetch_assoc($r);
                                                  ?>
                                                <input type="text" class="form-control" name="" value="<?php echo $rr['projectname']; ?> " disabled> 
                                                <input type="text" name="project_id" value="<?php echo $rr['id']; ?> " hidden> 
                                               </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Utilization No</label>
                                               <div class="col-sm-4">
                                                ...
                                                $uno = $uno + 1;
                                                ?>
                                                <input type="text" class="form-control" placeholder="Utilization No" value="<?php echo $uno ?>" name="uno" autocomplete="off" required/>
                                               </div>
...
<td >
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~SELECT~~</option>
                <option value="1">In Pakistan</option>
                <option value="2">Out Of Pakistan</option>
              </select>
            </div>
                                               </div>
                                            </div>
