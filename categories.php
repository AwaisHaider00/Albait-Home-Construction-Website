...
if(isset($_GET['op']))
{
     ...
     $deleteQuery = "delete from categories where categories_id = '$id' ";
     ...
     {
          print("Something went wrong ".mysqli_error($connect));
     }
}
    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="?id=<?php echo $row['categories_id']?>&op=delete" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
